    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                {{-- <div class="form-group row">
                    <label for="weight" class="col-md-2 col-form-label text-md-right">{{ __('Weight') }}</label>
                ...
                <div class="form-group row">
                    <label for="dimension" class="col-md-2 col-form-label text-md-right">{{ __('Dimension') }}</label>

                    <div class="col-md-9">
                        <input id="dimension" rows="3" class="form-control{{ $errors->has('dimension') ? ' is-invalid' : '' }}" name="dimension" value="{{ old('dimension') }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="material" class="form-control{{ $errors->has('material') ? ' is-invalid' : '' }}" name="material" value="{{ old('material') }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="import_price" type="number" class="form-control{{ $errors->has('import_price') ? ' is-invalid' : '' }}" name="import_price" value="{{ old('import_price') }}" required autofocus >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="discount" type="number" class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" name="discount" value="{{ old('discount') }}" required autofocus>
